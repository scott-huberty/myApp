...
class MNEVisualizer:
    ...
    def __init__(self, app, inst, dcc_graph_kwargs=None,
                 ...
                 annot_created_callback=None, plot_n_chans=20):
        self.app = app
        self.scalings_arg = scalings
        self.inst = None
        if inst is not None:
            self.set_inst(inst)
        self.n_sel_ch = plot_n_chans  # n of channels to display in plot
    ...
    def initialize_layout(self):
        ...
        self.layout = go.Layout(
                                ...
                                yaxis={'showgrid': True,
                                       ...
                                       'color': 'white',  # tick and title text color
                                       'range':[-self.n_sel_ch, 1],
                                       'fixedrange':True},
                                showlegend=False,
                                margin={'t': 25,'b': 25,'l': 70, 'r': 25},
